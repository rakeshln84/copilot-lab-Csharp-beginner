...
6. Create a new file `MusicStoreService.cs`. Using Copilot to generate the CRUD operations for the Music Store.
...
7. Add mock data to the `MusicStoreService` class to test the CRUD operations.
...
8. Modify the `Program.cs` file to use the new repository and print the albums.
